...
_DEFAULT: dict[str, Any] = {
    ...
    "backends": {
        ...
        "anthropic": {"api_key": ""},
        "google": {"api_key": ""},
        "openrouter": {"api_key": "", "site_url": "", "site_title": ""},
        "vllm": {"base_url": "http://localhost:8000/v1", "api_key": ""},
        "openai_compat": {"base_url": "http://localhost:5000/v1", "api_key": "", "label": "OpenAI-Compatible"},
