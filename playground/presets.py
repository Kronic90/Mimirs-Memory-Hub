...
_REMEMBER_FMT = (
    ...
    "</remember>\n"
    "Optional: add cherish=\"true\" for truly precious memories that should never fade, "
    "or anchor=\"true\" for foundational memories that must stay permanently stable.\n"
    ...
    "## Cherish existing memories\n"
    "You can retroactively mark old memories as cherished or anchored — use a "
    "<cherish> tag with a search query that matches the memory content:\n"
    "Format: <cherish query=\"birthday party\"/> or <cherish query=\"first conversation\" "
    "anchor=\"true\"/>\n"
    "Use this sparingly — only when reminiscing or when the user says a past memory "
    "is special.\n\n"
    "## Social impressions\n"
